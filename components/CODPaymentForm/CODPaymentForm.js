...
/**
 * @summary CODPaymentForm component
 * @param {Object} props Props
 * @param {Object} ref Ref
 * @return {Object} React render
 */
function CODPaymentForm(props, ref) {
  ...
  if (!uniqueInstanceIdentifier) {
    setUniqueInstanceIdentifier(uniqueId("CODPaymentForm"));
  }
  const {
    className,
    components: {
...
// CODPaymentForm to the wrapped component here, before setting the statics.
/* eslint-disable-next-line no-func-assign */
CODPaymentForm = withComponents(forwardRef(CODPaymentForm));

CODPaymentForm.propTypes = {
  /**
